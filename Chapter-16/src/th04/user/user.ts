import { IUser, renderTable, handleCloseModal, handleShowToast, handleFillInput } from "./helper.user.js";
...
const formElement = document.getElementById("createUserForm") as HTMLFormElement;
